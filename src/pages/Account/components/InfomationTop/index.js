...
const InfomationTop = ({ users ,isLogin}) => {
  ...
  return (
    ...
    <div className="info-top-title">
        <p>"Hi ! <strong>{`${fistName} ${lastName}`}</strong></p>
        <p>Từ bảng thông tin tài khoản, bạn có thể xem bản sao các hoạt động của tài khoản bạn trong thời gian gần đây và cập nhật thông tin tài khoản của bạn. Chọn liên kết bên dưới để xem hoặc chỉnh sửa thông tin”</p>
    </div>
    <div className="info-top">
      ...
      <label htmlFor="fileInput">
        ...
        >
          ...
          {hovered && <span className="text-overlay"><AiFillCamera className="icons-camera"/> Đổi avatar</span>}
        </div>
      </label>
      <input
        id="fileInput"
      ...
      <div className="title-info-upload">
        ...
        <h3>Username :<span>{email}</span></h3>
      </div>
    </div>
    </>
